...
def apply_random_transformations_and_save(img, train_output_folder, test_output_folder, station_name, num_new_images=100, grayscale=False):
    for i in range(num_new_images):
        choices = ['gaussian', 'saltpepper', 'brightness', 'rand_bright', 'rotate']
